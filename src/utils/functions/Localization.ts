...
export function setOptionsLocalization<K extends SanitizedOptions & { name?: string }>({ options, target, localizationSource, nameFallback }: {
    options: K
...
export function setFallbackDescription<K extends SanitizedOptions>(options: K & { description?: string }) {
